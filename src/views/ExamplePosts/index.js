...
import { Row, Col, Card, CardBody, CardFooter, Badge, Button } from "shards-react";

import PageTitle from "../../components/PageTitle";

class ExamplePosts extends React.Component {
  constructor(props) {
    super(props);
          ...
          {PostsListFour.map((post, idx) => (
            <Col lg="3" md="6" sm="12" className="mb-4" key={idx}>
              <Card small className="card-post h-100">
                ...
                <CardBody>
                  <h5 className="card-title">
                    <a className="text-fiord-blue" href="#">{post.title}</a>
                  </h5>
                ...
                <CardFooter className="text-muted border-top py-3">
                  <span className="d-inline-block">
                    By
                    <a className="text-fiord-blue" href={post.authorUrl}>{post.author}</a>{" "}
                    in
                    <a className="text-fiord-blue" href={post.categoryUrl}>{post.category}</a>
                  </span>
                </CardFooter>
              </Card>
            </Col>
